...
const NotificationsPage = () => {
    ...
    const removeNewNotif = (notificationID) =>
        dispatch(actions.removeNewNotification(notificationID));

    const onClearNotificationHandler = (id, from) => {
        removeNewNotif(id);
        toast.success(`You have successfully clear this notification`, {
            autoClose: 2500,
                ...
                <div className="notificationsP-newNotifications borderedDiv">
                    ...
                    <div className="notificationsP-Content">
                        {newNotif.map((i) => {
                            return (
                                <div
                                    className="notificationsP-OneMessage d-flex ai-center jc-space_between"
                                    key={i.id}
                                >
                                    ...
                                    <div className="notificationsP-Buttons d-flex ai-center">
                                        <Button
                                            text={
                                                <FormattedMessage defaultMessage="View" id="View" />
                                            }
                                            className="blueLight larger"
                                        />
                                        <Button
                                            onClick={() => onClearNotificationHandler(i.id)}
                                            text={
